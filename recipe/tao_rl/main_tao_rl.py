...
from recipe.tao_rl.tao_rl_ray_trainer import RayTAORLTrainer
...
@hydra.main(config_path="config", config_name="tao_rl_trainer", version_base=None)
def main(config):
    run_tao_rl(config)


def run_tao_rl(config) -> None:
